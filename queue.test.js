...
adf
  it.optional('should return correct linked list', () => {
    ...
    const queue = new Queue();sdf
    values.forEach(value => queue.enqueue(value));
    for (let i = 0; i < dequeueCount; i++) queue.dequeue();sdfsdf
